public class DemoEncapsulation {
    ...
    public static void main(String[] args) {
       ...
       public - It can be accessed from within the class,
        ...
        */
        ...
        Person person1 = new Person("Kaloyan", 18, new Address("Sofia"));

        Person person2 = new Person("default", -1, new Address("DEFAUL"));
